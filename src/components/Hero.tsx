...
import heroImg from "../../public/img/BUDGETTING-lightmode.svg";
import heroImgDark from "../../public/img/BUDGETTING-dark.svg";
...
export const Hero = () => {
	...
	return (
		<>
			<Container className="flex flex-wrap mb-20 lg:mb-32">
				<div className="flex items-center w-full lg:w-1/2">
					<div className="max-w-2xl mb-8">
						...
						<p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
							FinTrail simplifies your finances with automatic expense tracking,
							seamless bill splitting, and real-time portfolio updates. Secure,
							user-friendly, and tailored to your financial needs.
						</p>
						...
						<div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
							{/* <a
								...
								target="_blank"
								rel="noopener"
								className="px-8 py-4 text-lg font-medium text-center text-white bg-indigo-600 rounded-md hover:bg-indigo-700 hover:shadow-lg dark:bg-indigo-500 dark:hover:bg-indigo-600"
							>
