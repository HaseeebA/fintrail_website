        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              FinTrail simplifies your finances with automatic expense tracking, seamless bill splitting, and real-time portfolio updates. Secure, user-friendly, and tailored to your financial needs.
            </p>
