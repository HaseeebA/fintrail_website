			...
			<Container>
				<div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-300 dark:border-trueGray-700 lg:grid-cols-5">
					<div className="lg:col-span-2">
						...
						<div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
							FinTrail is the all-in-one finance app designed to automate
							expense tracking, simplify bill splitting, and provide real-time
							portfolio updates. Built with cutting-edge technology, it is
              ...
              >
                ...
                <Facebook />
							...
							<a
								href="https://linkedin.com/company/fintrailapp"
								target="_blank"
								rel="noopener"
							>
					...
					<div>
						...
						<p className="mt-1 text-gray-500 dark:text-gray-400">
							Email:{" "}
							<a
								href="mailto:fintrailapp@gmail.com"
								className="hover:text-indigo-500 dark:hover:text-indigo-500"
							>
